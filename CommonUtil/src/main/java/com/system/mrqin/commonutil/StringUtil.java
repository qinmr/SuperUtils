...
public class StringUtil {
    ...
    public static boolean isNotEmpty(TextView tv) {
        return isNotEmpty(getString(tv));
    }
    ...
    public static boolean isNotEmpty(Object object) {
        return isNotEmpty(getString(object));
    }
    ...
    public static boolean isNotEmpty(CharSequence cs) {
        return isNotEmpty(getString(cs));
    }
...
//			}
        ...
        Log.i(TAG, "getPrice correctPrice =  " + correctPrice + " >>>>>>>>>>>>>>>>");
        return isNotEmpty(correctPrice) ? getPrice(new BigDecimal(0 + correctPrice), formatType) : getPrice(0, formatType);
    }
